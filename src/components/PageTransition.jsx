    ...
    >
      ...
      <div className="relative flex flex-col items-center space-y-8">
        ...
        <div className="text-center mb-6">
          <div className="text-4xl font-light text-white mb-3 tracking-wide">CINEMAX</div>
          <div className="h-px w-32 bg-gradient-to-r from-transparent via-yellow-400 to-transparent mx-auto mb-3"></div>
          <div className="text-white/40 text-xs font-light tracking-widest uppercase">Explore Movie Details</div>
        </div>
        ...
        <div className="text-center">
          <div className="text-white/80 text-sm font-light mb-4 tracking-wide">Loading</div>
